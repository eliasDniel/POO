...
from utilities import reset_color,red_color,VERDE,VERDE
...
class CrudClients(ICrud):
    def create(self):
        ...
        gotoxy(65,2);print(VERDE+"Registro de clientes")
        gotoxy(52,3);print(VERDE+Company.get_business_name())
        gotoxy(1,4);print(VERDE+"*"*167)
        gotoxy(60,5);print("Formulario de registro")
        gotoxy(60,6);print("Ingresa tu DNI:")
        gotoxy(60,7);print("Ingresa tu nombre:")
        gotoxy(60,8);print("Ingresa tu apellido:")
        gotoxy(60,9);print("Tipo de cliente (R/V):")
        gotoxy(76,6);dni = validar.validar_numero_dni("Error: No tiene formato DNI", 76, 6)
        gotoxy(79,7);nombre = validar.validar_nombre_cliente(col=79, fil=7)
        gotoxy(81,8);apellido = validar.validar_nombre_cliente(col=81, fil=8)
        gotoxy(83,9);tipo_cliente = input().lower()
        gotoxy(60,10);print(red_color+"Esta seguro de registrar el cliente?🤔 (y/n):")
        gotoxy(106,10);procesar = input().lower()
        if procesar.lower() == "y":
            ...
            if validar.validar_registro(clientesArchivo, data):
                gotoxy(60, 12); print(VERDE+"El cliente ya se encuentra registrado🥲")
                time.sleep(2)
            else:
                clientesArchivo.append(data)
                json_file = JsonFile(path+'/archivos/clients.json')
                json_file.save(clientesArchivo)
                gotoxy(60, 12); print(VERDE+"Registro exitoso! ✅")
                time.sleep(2)
        else:
            gotoxy(60, 11); print(red_color+"Registro cancelado ❌...")
            gotoxy(60, 12); print(VERDE+"¿Quieres intentarlo de nuevo? (y/n):")
            gotoxy(97, 12);retry = input().lower()
            if retry == 'y':
                self.create()
            else:
                time.sleep(2)
    ...
    def update(self):
        ...
        gotoxy(1,2);print(VERDE+"*"*167)
        json_file = JsonFile(path+'/archivos/clients.json')
        lista_clientes=json_file.read()
        gotxy_frame(25,3,100,len(lista_clientes)+5)
        gotoxy(65,4);print(f"Lista de clientes")
        gotoxy(25,5);print(VERDE+"*"*100)
        ...
        if lista_clientes:
            ...
            gotoxy(25,len(lista_clientes)+10);print("Ingresa el DNI:")
            gotoxy(41,len(lista_clientes)+10);dni = validar.validar_numero_dni("Error: DNI no valido", 41, len(lista_clientes)+10)
            cliente_dni = json_file.find("dni",dni)
            if cliente_dni:
                gotxy_frame(25,len(lista_clientes)+10,100,10)
                gotoxy(26,len(lista_clientes)+11);print(f"Datos personales")
                gotoxy(25,len(lista_clientes)+12);print(VERDE+"*"*100)
                gotoxy(26,len(lista_clientes)+13);print(f"Hola, {cliente_dni[0]['nombre']} aqui puedes actualizar")
                gotoxy(26,len(lista_clientes)+14);print(f"Ingresa el nombre: {cliente_dni[0]['nombre']}")
                gotoxy(45,len(lista_clientes)+14);nombre = validar.validar_nombre_cliente(44,len(lista_clientes)+14)
                gotoxy(26,len(lista_clientes)+15);print(f"Ingresa el apellido: {cliente_dni[0]['apellido']}")
                gotoxy(47,len(lista_clientes)+15);apellido = validar.validar_nombre_cliente(46,len(lista_clientes)+15)
                data=json_file.read()
                cliente=cliente_dni[0]
                gotoxy(25,len(lista_clientes)+16);print(red_color+"Estas seguro de actualizar tus datos?🤔(y/n):")
                gotoxy(72,len(lista_clientes)+16);procesar = input().lower()
                if procesar.lower() == "y":
                    for i in data:
                        if i['dni'] == cliente['dni']:
                            i['nombre']=nombre.upper() if nombre else i['nombre']
                            i['apellido']=apellido.upper()  if apellido else i['apellido']
                            gotoxy(26,len(lista_clientes)+17);print(VERDE+"Actualizacion exitosa! ✅")  
                            time.sleep(2)               
                else:
                    gotoxy(26,len(lista_clientes)+17);print(VERDE+"Se cancelo la actualizacion ❌...")
                    time.sleep(2)
    ...
    def delete(self):
        ...
        if lista_clientes:
            ...
            gotoxy(25,len(lista_clientes)+10);print(VERDE+"Elige como deseas eliminar (T/DNI):")
            gotoxy(61,len(lista_clientes)+10);procesar = input().lower()
            if procesar.lower() == "dni":
                ...
                cliente_dni = json_file.find("dni",dni)
                if cliente_dni:
                    gotoxy(7,len(lista_clientes)+12);print(VERDE+"Estas seguro de realizar la eliminacion🤔?(y/n):")
                    gotoxy(57,len(lista_clientes)+12);procesar = input().lower()
                    if procesar.lower()=='y':
                        lista_clientes.remove(cliente_dni[0])
                        json_file.save(lista_clientes)
                        gotoxy(7,len(lista_clientes)+14);print(VERDE+"Eliminado con exito! ✅")
                        time.sleep(3)  
                    else:
                ...
                gotoxy(7,len(lista_clientes)+11);print(VERDE+"Estas seguro de eliminar todos los clientes?(y/n):")
                gotoxy(59,len(lista_clientes)+11);procesar = input().lower()
                if procesar.lower() == 'y':
                    lista_clientes=[]
                    json_file.save(lista_clientes)
                    gotoxy(7,len(lista_clientes)+13);print(VERDE+"Eliminado con exito! ✅")
                    time.sleep(2)
                else:
                    gotoxy(7,len(lista_clientes)+13);print(red_color+"Eliminacion cancelada❌...")
                    time.sleep(2)
        else:  
            gotoxy(60,9);print(VERDE+"No se han registrado clientes🥲")
        time.sleep(3)
    ...
    def consult(self):
        ...
        if lista_clientes:
            ...
            if cliente_dni:
                ...
                gotoxy(70,11);print(VERDE+'Cliente no existe🥲')
        else:
            gotoxy(70,11);print(VERDE+'No se han registrado clientes🥲')
        time.sleep(5) 
...
class CrudProducts(ICrud):
    def create(self):
        ...
        borrarPantalla()
        gotxy_frame(0,0,167,100)
        gotoxy(65, 2); print(VERDE + "Registro de Producto")
        gotoxy(50,3); print(VERDE + Company.get_business_name())
        gotoxy(2,4);print(VERDE+"*"*167)
        ...
        gotoxy(7,9);print(VERDE+"Esta seguro de guardar el producto(y/n):")
        gotoxy(48,9);procesar = input().lower()
        if procesar == 'y':
            if encontrado:
                gotoxy(7,10);print(VERDE+"Producto ya registrado. 😢")
                time.sleep(2)
                return
            else:
                products.append(new_product.getJson())
                json_file.save(products)
                gotoxy(7, 10); print(VERDE+"Producto registrado exitosamente! ✅")
                time.sleep(2)
        else:
    ...
    def update(self):
        ...
        if lista_productos:
            ...
            if product_id:
                ...
                gotoxy(25,len(lista_productos)+12);print(VERDE+"*"*125)
                ...
                while True:   
                    ...
                    if opc == "1":
                        ...
                        gotoxy(6,5);print(VERDE+"Estas seguro de actualizar tus datos🤔?(y/n):")
                        gotoxy(52,5);procesar = input().lower()
                        if procesar.lower() == "y":
                            for i in data:
                                if i['id'] == producto['id']:
                                    i['descripcion']=descripcion
                                    gotoxy(6,6);print(VERDE+"Actualizado con exito ✅")
                                    time.sleep(1)
                            json_file.save(data)
                            time.sleep(1)
                            break
                ...
                gotoxy(25,len(lista_productos)+12);print(VERDE+"El Id del producto no se encuentra registrado🥲...")
                time.sleep(1)
        else:
            gotoxy(6,6);print(VERDE+"No hay productos registrados🥲...")
            time.sleep(2)
        time.sleep(3)
        ...
        if products:
            ...
            if procesar.lower() == "id":
                while True:
                    ...
                    product_id = json_file.find("id",int(id))
                    if len(product_id) != 0:
                        gotoxy(25,len(products)+9);print(red_color+"Estas seguro de realizar la eliminacion🤔?(y/n):")
                        gotoxy(75,len(products)+9);procesar = input().lower()
                        if procesar.lower()=='y':
                            products.remove(product_id[0])
                            json_file.save(products)
                            gotoxy(25,len(products)+11);print(VERDE+"Eliminado con exito! ✅")
                            break
                        else:
                        ...
                        gotoxy(24,len(products)+9);print(VERDE+"DNI no encontrado🥲")
                        time.sleep(3) 
            elif procesar.lower() == "t":
                gotoxy(25,len(products)+8);print(VERDE+"Estas seguro de eliminar todos los productos🤔?(y/n):")
                gotoxy(80,len(products)+8);procesar = input().lower()
                if procesar.lower() == 'y':
                    products=[]
                    json_file.save(products)
                    gotoxy(25,len(products)+11);print(VERDE+"Se elimino todo correctamente! ✅")
                    time.sleep(2)
                else:
                    gotoxy(25,len(products)+11);print(red_color+"Eliminacion cancelada❌...")
                    time.sleep(2)
        else:  
            gotoxy(10,3);print(VERDE+"No se han agregado productos🥲")
        time.sleep(3)
    ...
    def consult(self):
        ...
        if lista_productos:
            ...
            if producto_id:
                ...
                gotoxy(65,len(lista_productos)+13);print(VERDE+f"Datos del producto con id: #{producto_id[0]['id']}")
                gotoxy(25,len(lista_productos)+14);print(VERDE+"*"*120)
                ...
                if lista_productos_stock_mayor:
                    ...
                    gotoxy(60,len(lista_productos)+25);print(VERDE+f"Map stock de productos: {totales_map}")
                gotoxy(60,len(lista_productos)+26);print(VERDE+f"Gacias por usar el sistema😎")
                time.sleep(5)
            else:
                gotoxy(60,len(lista_productos_stock_mayor)+18);print(VERDE+'Producto no existe🥲')
            time.sleep(5)
        else:
            gotoxy(60,11);print(VERDE+'No hay productos pregistrados🥲')
        time.sleep(5)
...
class CrudSales(ICrud):
    def create(self):
        ...
        borrarPantalla()
        gotxy_frame(0,0,167,100)
        gotoxy(30,2);print(VERDE+"Registro de Venta")
        gotoxy(17,3);print(VERDE+Company.get_business_name())
        ...
        gotoxy(2,8);print(VERDE+"*"*90+reset_color) 
        gotoxy(5,9);print(VERDE+"Linea") 
        ...
        while follow.lower()=="s":
            ...
            if not prods:
                gotoxy(24,9+line);print(VERDE+"Producto no existe🥲")
                time.sleep(1)
                ...
                gotoxy(76,9+line);print(VERDE+"🛒✔"+reset_color)  
                line += 1
        gotoxy(15,9+line);print(VERDE+"Esta seguro de grabar la venta(s/n):")
        gotoxy(54,9+line);procesar = input().lower()
        if procesar == "s":
            gotoxy(15,10+line);print(VERDE+"😊 Venta Grabada satisfactoriamente 😊")
            # print(sale.getJson())  
            ...
            gotoxy(20,10+line);print(red_color+"🤣 Venta Cancelada 🤣")    
        time.sleep(2)
    ...
    def update(self):
        ...
        if invoices:
            ...
            if factura_id:
                ...
                gotoxy(65,2);print(VERDE+" Actualizar Factura ")
                gotoxy(50,3);print(VERDE+Company.get_business_name())
                ...
                gotoxy(2,7);print(VERDE+"*"*164)
                gotoxy(65,9);print(f"Detalles de la compra")
                gotoxy(25,10);print(VERDE+"*"*120)
                ...
                while opcion !='2': 
                    ...
                    if opcion == "1":
                        gotxy_frame(65,len(detalle)+13,54,len(detalle)+14)
                        gotoxy(67,len(detalle)+14);print(VERDE+"Productos en el detalle:")
                        for i in range(len(detalle)):
                            gotoxy(67,len(detalle)+16+i);print(f"{i + 1}. {detalle[i]['poducto']} - Cantidad: {detalle[i]['cantidad']}")
                        gotoxy(67,len(detalle)+20);print(VERDE+'Escoge el indice:')
                        gotoxy(85,len(detalle)+20);indice_producto = int(validar.solo_numeros('Error: Solo enteros',85,len(detalle)+20)) - 1
                        if 0 <= indice_producto < len(detalle):
                            gotoxy(67,len(detalle)+21);print(VERDE+'Ingresa el Id del nuevo Producto:')
                            gotoxy(100,len(detalle)+21);id = validar.solo_numeros('Error: Solo numeros',100,len(detalle)+21)
                            ...
                            if product_id:
                                gotoxy(67,len(detalle)+22);print(VERDE+'Nueva cantidad:')
                                gotoxy(83,len(detalle)+22);nueva_cantidad = int(validar.solo_numeros('Error: Solo enteros',83,len(detalle)+22))
                                gotoxy(67,len(detalle)+23);print(VERDE+"Confirma tu DNI:")
                                gotoxy(84,len(detalle)+23);dni = validar.solo_numeros("Error: Solo números",84,len(detalle)+23)
                                gotoxy(67,len(detalle)+24);print(VERDE+"Tipo de cliente (r/v):")
                                gotoxy(92,len(detalle)+24);respuesta=input().lower()
                                ...
                                if cliente_nombre:
                                    ...
                                    gotoxy(67,len(detalle)+25);print(VERDE+f"Subtotal: {round(sale.subtotal, 2)}")
                                    gotoxy(67,len(detalle)+26);print(VERDE+f"Descuento: {round(sale.discount, 2)}")
                                    gotoxy(67,len(detalle)+27);print(VERDE+f"Iva     : {round(sale.iva, 2)}")
                                    gotoxy(67,len(detalle)+28);print(VERDE+f"Total   : {round(sale.total, 2)}")
                                    gotoxy(67,len(detalle)+29);print(VERDE + "¿Guardar cambios?(s/n): ")
                                    gotoxy(90,len(detalle)+29);procesar = input().lower()  # Pregunta si se quiere grabar la venta
                                    if procesar == "s":
                                        gotoxy(67,len(detalle)+31);print(VERDE+"😊 Actualización Grabada satisfactoriamente 😊")       
                                        data = sale.getJson()
                                    ...
                                    gotoxy(67,len(detalle)+24);print(VERDE+"El cliente no existe🥲.")
                                    time.sleep(2)
                            else:
                                gotoxy(84,len(detalle)+23);print(VERDE+"Producto no existe🥲")
                                time.sleep(1)
                        else:
                ...
                gotoxy(60,len(invoices)+7);print(VERDE+"No se encontro la factura se encontro🥲")
        else:
            gotoxy(60,len(invoices)+7);print(VERDE+"No se ha registrado registradas🥲")
    ...
    def delete(self):
        ...
        if facturas:
            ...
            gotoxy(40,5);print(VERDE+f"Factura")
            gotoxy(70,5);print(VERDE+f"Fecha")
            gotoxy(100,5);print(VERDE+f"Cliente")
            ...
            gotoxy(25,len(facturas)+7);print(VERDE+"Escoge un metodo de eliminacion(T/ID):")
            ...
            if procesar.lower() == "id":
                while True:
                    ...
                    if factura_id:
                        gotoxy(25,len(facturas)+9);print(VERDE+"Estas seguro de realizar la eliminacion🤔?(y/n):")
                        gotoxy(75,len(facturas)+9);procesar = input().lower()
                        if procesar.lower()=='y':
                            facturas.remove(factura_id[0])
                            json_file.save(facturas)
                            gotoxy(25,len(facturas)+11);print(VERDE+"Eliminado con exito ✅")
                            break
                        else:
                        ...
                        gotoxy(24,len(facturas)+9);print(VERDE+"DNI no encontrado🥲")
                        time.sleep(3) 
            elif procesar.lower() == "t":
                gotoxy(25,len(facturas)+8);print(VERDE+"Estas seguro de eliminar todos los productos🤔?(y/n):")
                gotoxy(80,len(facturas)+8);procesar = input().lower()
                if procesar.lower() == 'y':
                    facturas=[]
                    json_file.save(facturas)
                    gotoxy(25,len(facturas)+11);print(VERDE+"Se elimino todo correctamente ✅")
                    time.sleep(2)
                else:
                    gotoxy(25,len(facturas)+9);print(red_color+"Eliminacion cancelada❌...")
                    time.sleep(2)
        else:  
            gotoxy(60,5);print(VERDE+"No se han agregado productos🥲")
        time.sleep(3)
    ...
    def consult(self):
        ...
        if id:
            ...
            if factura_id:
                ...
                gotoxy(60, 2); print(" " * (50))
                gotoxy(2, 3); print(" " * (164))
                gotoxy(65,2);print(VERDE+" Consultar Factura ")
                gotoxy(50,3);print(VERDE+Company.get_business_name())
                gotoxy(30,4);print(f"Factura#: {factura_id[0]['factura']} {' '*60} Fecha: {factura_id[0]['Fecha']}")
                gotoxy(30,5);print(f"Cliente: {factura_id[0]['cliente']}")
                gotoxy(2,7);print(VERDE+"*"*164)
                gotoxy(65,9);print(VERDE+f"Detalles de la compra")
                gotoxy(25,10);print(VERDE+"*"*120)
                gotoxy(30,11);print(f"#")
                gotoxy(60,11);print(f"Producto")
                gotoxy(90,11);print(f"Precio")
                ...
                gotoxy(122,len(detalle)+14);print(f"Decuento: {round(factura_id[0]['descuento'],2)}")
                gotoxy(122,len(detalle)+15);print(f"Iva     : {factura_id[0]['iva']}")
                gotoxy(60,len(detalle)+16);print(VERDE+f"Gacias por usar el sistema😎")
            else:
                gotoxy(60,11);print('Factura no existe🥲')
        else:
            ...
            gotoxy(25,9);print(VERDE+"*"*120)
            gotxy_frame(25,len(facturas)+11,60,8)
            gotoxy(40,len(facturas)+12);print(VERDE+f"Detalles de facturas en general")
            gotoxy(27,len(facturas)+13);print(VERDE+f"Map Facturas:{totales_map}")
            gotoxy(27,len(facturas)+14);print(VERDE+f"Max Factura:{max_invoice}")
            gotoxy(27,len(facturas)+15);print(VERDE+f"Min Factura:{min_invoice}")
            gotoxy(27,len(facturas)+16);print(VERDE+f"Sum Factura:{tot_invoices}")
            gotoxy(27,len(facturas)+17);print(VERDE+f"Reduce Facturas:{suma}")
            time.sleep(10)
...
while opc !='4':  
    borrarPantalla()
    gotxy_frame(0,0,167,100)
    gotoxy(55,9);print(VERDE+f"{Company.get_business_name()}🏬")
    gotoxy(60,7);print(VERDE+f"BIENVENIDOS A MI SISTEMA DE FACTURACION😎🛒")
    menu_main = Menu("MENU DE FACTURACION",["1) Clientes","2) Productos","3) Ventas","4) Salir"],70,12)
    opc = menu_main.menu()
    if opc == "1":
        opc1 = ''
        while opc1 !='5':
            ...
            gotxy_frame(0,0,167,100)
            clients = CrudClients()  
            menu_clients = Menu("Menu Cientes",["1) Registrar cliente","2) Actualizar","3) Eliminar","4) Consultar","5) Salir"],60,10)
